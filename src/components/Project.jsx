...
<div className="left flex flex-col gap-2 md:ml-10">
  ...
  <p className='text-gray-700 text-justify w-[350px] md:w-[420px]'>I'm a paragraph. Click here to add your own text and edit me. It’s easy. Just click “Edit Text” or double click me to add your own content and make changes to the font. I’m a great place for you to tell a story and let your users know a little more about you</p>
</div>
